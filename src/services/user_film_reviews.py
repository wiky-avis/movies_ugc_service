...
class UserFilmReviewsService(BaseService):
    ...
    async def send_film_review(
        self, data: dict, body: Body  # type: ignore
    ) -> JSONResponse:
        ...
        review_title = dpath.get(body, "review_title", default=None)
        review_body = dpath.get(body, "review_body", default=None)
